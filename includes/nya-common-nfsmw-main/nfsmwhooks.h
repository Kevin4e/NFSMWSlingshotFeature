...
namespace NyaHooks {
	namespace OptionsMenuHook {
		...
		void __fastcall OptionsMenuHooked(IconScrollerMenu* pThis, void* edx, IconOption* widget) {
		...
		void __fastcall AudioOptionsHooked1(UIWidgetMenu* pThis, void* edx, FEToggleWidget* widget, bool a3) {
		...
		void __fastcall AudioOptionsHooked2(UIWidgetMenu* pThis, void* edx, FEToggleWidget* widget, bool a3) {
		...
		void __fastcall VideoOptionsHooked(UIWidgetMenu* pThis, void* edx, FEToggleWidget* widget, bool a3) {
		...
		void __fastcall GameplayOptionsHooked(UIWidgetMenu* pThis, void* edx, FEToggleWidget* widget, bool a3) {
	...
	namespace SchedulerHook {
		...
		void __fastcall HookedFunction(Scheduler* a1, void* edx, bool a2) {
			for (auto& func : aPreFunctions) {
				func();
			}
			OrigFunction(a1, a2);
	...
	namespace CameraMoverHook {		
		...
		void __fastcall HookedFunction(CameraMover* a1, void* edx, float a2) {
			OrigFunction(a1, a2);
			for (auto& func : aFunctions) {
				func(a1);
			}
